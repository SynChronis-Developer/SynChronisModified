...
urlpatterns = [
    ...
    path('manage-class/', ClassListView.as_view(), name='manage-class'),
    path('add-class/', AddClassView.as_view(), name='add-class'),
    path('update-class/<int:pk>/', UpdateClassView.as_view(), name='update-class'),
    ...
    path('generate-student-pdf/', GenerateStudentPDF.as_view(), name='generate_student_pdf'),
    path('generate-class-pdf/', GenerateClassPDF.as_view(), name='generate_class_pdf'),
